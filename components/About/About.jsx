      ...
      <div className="wrap">
        ...
        <div className={styles.layout}>
          <div className={styles.copy}>
            ...
            <p>KJAH Studio is a team of <strong>four core specialists</strong> &mdash; formerly solo professionals, each a proven expert in their field. We came together to build something stronger than any of us alone.</p>
            <p>We specialize in <strong>fully functional websites and sales funnels</strong> with complete back-end automation: domain configuration, email automation, third-party software integration, and workflow logic &mdash; all handled end-to-end.</p>
